...
[^1]:
  Elias Tarnaras, Unlocking the Secrets of PDF Parsing: A Comparative Analysis of Python Libraries, 2024 (accessed on Aug 31st).
[^2]:
  As I move forward with the project, we're also exploring production grade and commercially open tools.
